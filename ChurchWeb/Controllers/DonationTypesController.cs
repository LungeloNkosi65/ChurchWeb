...
namespace ChurchWeb.Controllers
{
    public class DonationTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "DonationTypeId,TypeName")] DonationType donationType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "DonationTypeId,TypeName")] DonationType donationType)
        {
            if (ModelState.IsValid)
            {
